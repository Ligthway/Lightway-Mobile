...
struct FallingMetalParticlesWithRectangleView: UIViewRepresentable {
    let height: CGFloat
    ...
    class UIMetalParticleView: UIView {
        ...
        var renderer: FallingParticleWithRectangleRenderer?
        ...
        func setup() {
            ...
            renderer = FallingParticleWithRectangleRenderer(device: device)
